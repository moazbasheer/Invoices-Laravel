								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											...
											<span class="badge badge-pill badge-warning mr-auto my-auto float-left"><a href="{{route('markAllAsRead')}}">حدد الكل كمقروء</a></span>
										</div>
										<p id="countNotifications" class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">لديك {{Auth::user()->unreadNotifications->count()}} اشعارات غير مقروءة</p>
									</div>
									<div id="unreadNotifications" class="main-notification-list Notification-scroll">
										@foreach(Auth::user()->unreadNotifications as $notification)
										<a class="d-flex p-3 border-bottom" href="{{route('invoice.print', $notification->data['id'])}}">
